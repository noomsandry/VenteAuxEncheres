...
class PersonneController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('personne_show', array('numpers' => $personne->getNumpers()));
        }
     ...
     *
     * @Route("/{numpers}", name="personne_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{numpers}/edit", name="personne_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Personne $personne)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('personne_edit', array('numpers' => $personne->getNumpers()));
        }
     ...
     *
     * @Route("/{numpers}", name="personne_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Personne $personne)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('personne_delete', array('numpers' => $personne->getNumpers())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
